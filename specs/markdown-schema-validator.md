...
**REQ-001**: The system shall authenticate users via username and password.

**REQ-002**: WHEN a user enters invalid credentials, the system shall reject the login attempt.

**REQ-003**: IF three consecutive login attempts fail, THEN the system shall lock the account.
```
...
**REQ-001**: The system authenticates users.
```
