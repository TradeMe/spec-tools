...
The system shall automatically exclude common VCS and tool directories:
- `.git/`, `.hg/`, `.svn/`, `.bzr/`
- `.venv/`, `venv/`, `env/`
- `node_modules/`
...
### AC-01: Auto-Exclude VCS Directories

**Given** a project with `.git/`, `.venv/`, and `node_modules/` directories
**When** the validator scans for markdown files
**Then** it shall exclude `.git/`, `.venv/`, and `node_modules/` directories automatically
**And** it shall NOT exclude `.claude/` directory
**And** excluded files shall not appear in any validation results
